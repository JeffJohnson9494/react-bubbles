...
- [ ] Explain what a token is used for.
      tokens are used for security via authentication(not allowing components or data to be accessed without the proper token)
- [ ] What steps can you take in your web apps to keep your data secure?
      encryption and tokens?
- [ ] Describe how web servers work.
      web servers hold data to be accessed via http when the consumer requests it
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      PUT(both create and update)and POST(create)
